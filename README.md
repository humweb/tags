...
```bash
php artisan vendor:publish --provider="Humweb\Tags\TagsServiceProvider" --tag="tags-migrations"
```
...
```bash
php artisan vendor:publish --provider="Humweb\Tags\TagsServiceProvider" --tag="tags-config"
```
